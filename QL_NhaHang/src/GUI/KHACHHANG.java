...
public class KHACHHANG extends javax.swing.JFrame {
   ...
   Vector tblData = new Vector();
    ...
    public Boolean KiemTraTXT(){
        if(txtmakh.getText().equals("") || txttenkh.getText().equals("")|| txtsdtkh.getText().equals("")){
    ...
    public Boolean ktmahople(){
        ...
        String dau = makh.substring(0,1);
        if(dau.equals("KH") == false){
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đúng mã khách là KHxxx với x là số", "Thông báo", 2);
            return false;
        }
        try {
            int duoi = Integer.parseInt(makh.substring(1));
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập đúng mã khách là KHxxx với x là số", "Thông báo", 2);
            return false;
        }
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        if(KiemTraTXT() ){
            if(JOptionPane.showConfirmDialog(this, "Bạn có chắc muốn thêm không?", "Thông báo", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                String sql = "insert into KHACHHANG(MaKhachHang, TenKhachHang, SDT, NGSINH) values ('"+txtmakh.getText().trim()+"', N'"+txttenkh.getText().trim()+"', '"+txtsdtkh.getText().trim()+"', '"+txtngaysinh.getText().trim()+"')";
